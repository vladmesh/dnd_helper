...
def _default_ui_pairs() -> List[tuple[str, str, str]]:
    return [
        ...
        ("filters.flying.yes", "ru", "Летающий"),
        ("filters.flying.yes", "en", "Flying"),
        ("filters.flying.no", "ru", "Не летающий"),
        ("filters.flying.no", "en", "Not flying"),
        ("filters.cr.03", "ru", "0-3"),
        ("filters.cr.03", "en", "CR 0-3"),
        ("filters.cr.48", "ru", "4-8"),
