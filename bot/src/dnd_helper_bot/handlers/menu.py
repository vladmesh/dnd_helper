...
async def show_main_menu_from_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await query.answer()
    await query.message.edit_text("Главное меню:", reply_markup=build_main_menu_inline())
...
async def show_bestiarie_menu_from_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await query.answer()
    await query.message.edit_text("Бестиарий:", reply_markup=build_monsters_root_keyboard())
...
async def show_spells_menu_from_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await query.answer()
    await query.message.edit_text("Заклинания:", reply_markup=build_spells_root_keyboard())
